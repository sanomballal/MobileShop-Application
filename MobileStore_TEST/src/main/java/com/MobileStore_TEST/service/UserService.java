...
public class UserService {
    ...
    public void initRoleAndUser() {
        ...
        adminUser.setUserPassword(getEncodedPassword("12345678"));
        ...
        User user = new User();
        user.setUserName("Umesh123");
        user.setUserPassword(getEncodedPassword("Umesh"));
        user.setUserFirstName("Umesh");
        user.setUserLastName("Umesh");
